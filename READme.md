...
## Table of contents 
 ...
 ## What I learned
  - I learnt alignment in flexbox, usage of mrgin, padding, width, max-width and Hover effect box shadow etc.

  ## Continued development
   - I'll continue learning CSS for better resposive design, Accessibility improvements, Hover effects, CSS organization, and I'll complete more Frontend Mentor Challenges. 

 ## Author 
  - Name: Anees Ul Rehman
  - [Frontend Mentor Profile](https://www.frontendmentor.io/profile/Anees-ul-rehman-1)
  - [GitHub Profile](https://github.com/Anees-ul-rehman-1)
